...
import {meteorSchema} from '../validation/schemas.js';
import {roverPhotoSchema} from '../validation/schemas.js';

const router = express.Router();

router.get('/meteors', validateRequest(meteorSchema), async (req, res, next) => {
    try {
...
router.post('/rover-photo', validateRequest(roverPhotoSchema), async (req, res, next) => {
    try {
